...
## It takes ~15-20 minutes to build the week index for 192 million entries
...
## It takes ~ mins to read the ~130,000 job entries
...
We see that failure rate among the ~200,000 jobs that ran the last 24 hours was ~3%.  Next, let's see how much CPU time this corresponds to:
